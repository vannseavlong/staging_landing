      ...
      <div className="min-h-screen bg-white flex justify-center py-12 px-4 sm:px-6 lg:px-8 font-['Inter']">
        <div className="w-full max-w-4xl  p-8 lg:p-12">
          ...
          <section className="space-y-8 text-gray-700 leading-relaxed">
            <p>
              This Privacy Policy (the "Notice") governs the use and access of the
            bEasy App and Website (as defined below), including any content,
            functionality and services offered on or through
            https://beasy.info/ or the bEasy App and Suntel.io (hereinafter
            referred to as "Service") by Suntel Technology Cambodia Co., Limited
            (hereinafter referred to as "Suntel") and its
            affiliates/subsidiaries with its address at Flatiron by Meridian,
            FO-2312, FO-2313, FO-2314 Unit, Street 102, Phnom Penh City Center,
            Phum 1, Sangkat Srah Chak, Khan Daun Penh, Phnom Penh, Cambodia.
            </p>

           
            {/* SECTION 1: THE SERVICES */}
            <h2 className="text-2xl font-bold text-gray-900 pt-4" id="section-1"> A. COLLECTION OF PERSONAL DATA</h2>

            <p>
            "Personal Data" means information about you from which you are
            identifiable, including but not limited to your name, identification
            card number, birth certificate number, passport number, nationality,
            address, telephone number, fax number, bank details, credit card
            details, race, gender, date of birth, marital status, resident
            status, education background, financial background, personal
            interests, email address, your occupation, and any other similar
            information about you that may be collected, stored, used, and
            processed by Suntel.
            </p>
            ...
            not provide Suntel with your Personal Data, Suntel will not be able
            to process your Personal Data for the purposes outlined below. If
            you are an agent, vendor, supplier, or service provider, the
            provision of your Personal Data is mandatory and failure to provide
            it may be a breach of laws or regulatory requirements.
          </p>
          ...
          <p className="text-base">
            ...
            <h2 className="text-2xl font-bold text-gray-900 pt-4" id="section-2"> B. PURPOSE AND USAGE OF INFORMATION</h2>

            <h3 className="text-xl font-semibold text-gray-800"> 1. General use:</h3>
            ...
            {/* SECTION 3: PAYMENT */}
            <h2 className="text-2xl font-bold text-gray-900 pt-4" id="section-3">2. Customers of Suntel services:</h2>
             <ul className="list-disc pl-5 space-y-1 text-base">
              <li>
                To perform Suntel's obligations under any contract entered into
                with you.
              </li>
              ...
              <li>
                ...
                Applications (“App”), deliver the App to you, and provide a
                license for its use.
              </li>
              <li>
