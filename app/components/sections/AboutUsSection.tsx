...
// export default Para;
 ...
 return (
    <section className="bg-white md:py-20 lg:py-5 px-10 text-white">
      {/* Header */}
      <div className="mb-5 mt-10">
        <div className="flex items-center text-black mb-5 lg:mb-0 md:mb-5">
          <h5 className="font-[Inter] text-base font-bold leading-[24px] tracking-[2px] text-beasy-gradient mr-4 whitespace-nowrap opacity-80">
...
<div className="relative w-screen h-[251px] lg:h-[400px] md:h-[450px] overflow-hidden -mx-10">
  ...
  <div className="absolute inset-0">
   ...
   <div className="block md:hidden bg-[url('/images/Why_Choose_us_Draft_mobile.png')] bg-no-repeat bg-contain bg-center h-full w-full"></div>
    ...
    {/* Tablet */}
    <div className="hidden md:block lg:hidden bg-[url('/images/Why_Choose_us_tablet.png')] bg-no-repeat bg-contain bg-center  h-full w-full">
    </div>

    {/* Desktop */}
    <div className="hidden lg:block bg-[url('/images/about/Why.png')] bg-no-repeat bg-bottom bg-contain bg-fixed h-full w-full"></div>
  </div>
</div>
